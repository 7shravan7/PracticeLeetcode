...
public class UndergroundSystem {
	...
	Map<Integer, Map.Entry<String, Integer>> checkInMap;
	
	Map<String, Map.Entry<Double, Integer>> journeyMap;
	...
	public void checkIn(int id, String stationName, int t) {
		checkInMap.put(id, new AbstractMap.SimpleEntry<String, Integer>(stationName, t));
	}

	public void checkOut(int id, String stationName, int t) {
		Map.Entry<String, Integer> checkInData = checkInMap.get(id);
		String startStation = checkInData.getKey();
		int startTime = checkInData.getValue();
		String journeyMapKey = startStation+","+stationName;
		Map.Entry<Double, Integer> journeyData = journeyMap.getOrDefault(journeyMapKey, 
				new AbstractMap.SimpleEntry<Double, Integer>(0.0, 0));
		int journeyTime = t-startTime;
		double total = journeyData.getKey() + journeyTime;
		int valuesCount = journeyData.getValue()+1;
		journeyMap.put(journeyMapKey, new AbstractMap.SimpleEntry<Double, Integer>(total, valuesCount));
		checkInMap.remove(id);
	}

	public double getAverageTime(String startStation, String endStation) {
		String journeyMapKey = startStation+","+endStation;
		Map.Entry<Double, Integer> journeyData = journeyMap.get(journeyMapKey);
		double totalTime = journeyData.getKey();
		int journeyCount = journeyData.getValue();
